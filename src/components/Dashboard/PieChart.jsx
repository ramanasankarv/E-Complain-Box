...
const PieChart = ({ showTotalDone, showTotalInProgress, showTotalRaised, totalRasiedData, totalInComplainData, totalDoneData, totalBackgroundColor, totalBorderColor, totalDepartments }) => {
